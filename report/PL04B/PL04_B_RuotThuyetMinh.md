...
| Mã | Loại | Nội dung |
|---|---|---|
| 【SƠ-ĐỒ-01】 | sơ đồ | Figure 2.1 use-case |
| 【SƠ-ĐỒ-02】 | sơ đồ | Figure 2.3 activity deepfake |
| 【SƠ-ĐỒ-03】 | sơ đồ | Figure 2.4 activity eKYC |
| 【SƠ-ĐỒ-04】 | sơ đồ | Figure 2.5 sequence deepfake |
| 【SƠ-ĐỒ-05】 | sơ đồ | Figure 2.6 sequence eKYC |
| 【SƠ-ĐỒ-06】 | sơ đồ | Figure 3.24 deployment |
| 【SỬA-01】 | sửa | trùng số: Figure 2.2(model)→2.7 (2.2 đã là System architecture) |
| 【SỬA-02】 | sửa | trùng số: Figure 2.3(model)→2.8 |
| 【SỬA-03】 | sửa | trùng số: Figure 2.4(model)→2.9 |
| 【SỬA-04】 | sửa | trùng số: Figure 2.5(model)→2.10 |
| 【SỬA-05】 | sửa | SUMMARY: "three-stage"→"two-stage" (bỏ tầng ArcFace không có thật) |
| 【SỬA-06】 | sửa | SUMMARY liveness: sai phương pháp (MediaPipe/EAR/head-pose/ArcFace) → đổi đúng B4-liveness vs B4+DCT-liveness; bỏ ArcFace |
| 【SỬA-07】 | sửa | chính tả: "Artificial Intelligent"→"Intelligence" |
| 【SỬA-08】 | sửa | chính tả tiêu đề: "ASSURRANCE"→"ASSURANCE" |
| 【SỬA-09】 | sửa | đại từ: "our best"→"my best" (1 tác giả) |
| 【SỬA-10】 | sửa | mục lục: "ASSURRANCE"→"ASSURANCE" |
| 【SỬA-11】 | sửa | viết hoa acronym: "Rest API"→"REST API" |
| 【SỬA-12】 | sửa | sai số: "4 blocks" nhưng liệt kê 5 (FE/BE/Model/Monitoring/Alerting)→"five" |
| 【SỬA-13】 | sửa | chính tả: "EEvery"→"Every" |
| 【ẢNH-01】 | ảnh | Figure 1.2: The MBConv block → fig_1_2_mbconv.png.  |
| 【ẢNH-02】 | ảnh | Figure 1.3: Zigzag scan and the 16 frequency bands → fig_1_3_zigzag.png.  |
| 【ẢNH-03】 | ảnh | Figure 1.4: Gated cross-attention fusion → fig_1_4_gate_fusion.png.  |
| 【ẢNH-04】 | ảnh | Figure 2.2: System architecture → fig_2_2_architecture.png.  |
| 【SƠ-ĐỒ-07】 | sơ đồ MỚI | kiến trúc SFDCT (B4 + nhánh block-DCT + gated cross-attention) |
| 【SƠ-ĐỒ-08】 | sơ đồ MỚI | kiến trúc SFDCT-HFF (high-pass residual + multi-scale + residual-guided attention) |
| 【SƠ-ĐỒ-09】 | sơ đồ MỚI | kiến trúc B4-liveness baseline (B4 spatial-only + head nhị phân) |
| 【ẢNH-05】 | ảnh | Figure 3.1: Real/fake distribution → fig_3_1_distribution.png.  |
| 【ẢNH-06】 | ảnh | Figure 3.2: Real/fake pair + spectrum → fig_3_2_preprocess_realfake.png.  |
| 【ẢNH-07】 | ảnh | Figure 3.3: Mean frequency energy by band → fig_3_11_frequency.png.  |
| 【ẢNH-08】 | ảnh | Figure 3.5: Training curve of baseline (B4) → fig_3_3_train_b4.png.  |
| 【ẢNH-09】 | ảnh | Figure 3.7: Training curve of SFDCT (naive) → fig_3_4_train_naive.png.  |
| 【ẢNH-10】 | ảnh | Figure 3.10: ROC curves → fig_3_7_roc.png.  |
| 【ẢNH-11】 | ảnh | Figure 3.11: Precision-recall → fig_3_8_pr_curve.png.  |
| 【ẢNH-12】 | ảnh | Figure 3.12: Confusion matrix → fig_3_9_confusion.png.  |
| 【ẢNH-13】 | ảnh | Figure 3.13: t-SNE 2D projection → fig_3_10_tsne.png.  |
| 【ẢNH-14】 | ảnh | Figure 3.14: Grad-CAM heat map → fig_3_12_gradcam.png.  |
| 【ẢNH-15】 | ảnh | Figure 3.16: Gate value distribution → fig_3_13_gate_alpha.png.  |
| 【SƠ-ĐỒ-10】 | sơ đồ MỚI | REST request/response (mô tả ở mục 1.4) |
| 【SƠ-ĐỒ-11】 | sơ đồ MỚI | kiến trúc B4+DCT-liveness (B4 + block-DCT + gated fusion) |
| 【ẢNH-16】 | ảnh | Figure 3.4: Model summary of EfficientNet-B4 baseline → fig_3_4_summary_b4.png. 17.55M params — đếm param thật từ model load qua DETECTOR |
| 【ẢNH-17】 | ảnh | Figure 3.6: Model summary of SFDCT → fig_3_6_summary_sfdct.png. 18.08M params; nhánh block-DCT 0 param (biến đổi cố định), chỉ fusion thêm 0.53M |
| 【ẢNH-18】 | ảnh | Figure 3.8: Model summary of SFDCT-HFF (full) → fig_3_8_summary_hff.png. 22.77M params; HFStream +5.21M |
| 【ẢNH-19】 | ảnh | Figure 3.9: Training curve of SFDCT-HFF (HFF-R3) → fig_3_9_train_hff_r3.png. Claude generate từ console-capture 11 điểm thật (hff_r3); peak 0.7551/epoch, best-ckpt 0.7695 ở Bảng 3.5 |
| 【ẢNH-20】 | ảnh | Figure 3.15: Example SFDCT predictions on Celeb-DF-v2 test faces → fig_3_15_predictions.png. 8 ví dụ thật: 2 caught + 2 accepted + 2 flagged (FP) + 2 missed (FN), verdict@τ=0.5 |
| 【ẢNH-21】 | ảnh | Figure 3.17: LCC-FASD live vs spoof — examples and 16-band DCT footprint → fig_3_17_liveness.png. live/spoof thật + 16-band; spoof khác về không gian nhưng ≈ live ở band-DCT → giải thích §3.1.9 (freq branch không giúp) |
| 【CẦN-BẠN-01】 | cần bạn | Figure 3.18 model summary B4-liveness — bảng text |
| 【CẦN-BẠN-02】 | cần bạn | Figure 3.19 — ĐỀ XUẤT BỎ: metrics_liveness.json chỉ có số cuối, không có log per-epoch để dựng curve; Bảng 3.10 đã đủ |
| 【ẢNH-22】 | ảnh | Figure 3.20: ROC + score distribution of B4-liveness → fig_3_20_roc_b4_liveness.png. chạy model trên 7580 ảnh eval thật, AUC 0.9829 khớp metrics, EER≈7% |
| 【CẦN-BẠN-03】 | cần bạn | Figure 3.21 model summary B4+DCT-liveness — bảng text |
| 【CẦN-BẠN-04】 | cần bạn | Figure 3.22 — ĐỀ XUẤT BỎ: không có log per-epoch; Bảng 3.10 đã đủ |
| 【ẢNH-23】 | ảnh | Figure 3.23: ROC + score distribution of B4+DCT-liveness → fig_3_23_roc_b4dct_liveness.png. chạy model trên 7580 ảnh eval, AUC 0.9777 khớp metrics (≈ B4, freq không giúp) |
| 【CẦN-BẠN-05】 | cần bạn | Figure 3.25 home screen — ảnh chụp app; ứng viên frontend/dashboard-sample.png |
| 【CẦN-BẠN-06】 | cần bạn | Figure 3.26 deepfake screen — ảnh chụp app |
| 【CẦN-BẠN-07】 | cần bạn | Figure 3.27 liveness screen — ảnh chụp app |
| 【SỬA-14】 | sửa | mục 1.11 trùng tên với 1.10 → đổi thành "The eKYC Context and the Operating Point" |
| 【SỬA-15】 | sửa | mục lục: cập nhật tên mục 1.11 |
| 【DRAFT-01】 | draft | draft 1.11.1 vai trò eKYC chống deepfake |
| 【DRAFT-02】 | draft | draft 1.11.2 Circular 17 + điểm vận hành FPR<=5% |
| 【DRAFT-03】 | draft | draft 1.11.3 nhu cầu explainability (Grad-CAM) |
| 【DRAFT-04】 | draft | draft 1.12.1 vai trò liveness trong eKYC |
| 【DRAFT-05】 | draft | draft 1.12.2 loại tấn công trình diễn (print/replay/mask) |
| 【DRAFT-06】 | draft | draft 1.12.3 passive vs active liveness |
| 【SỬA-16】 | sửa | xóa khối template tiếng Việt sót ở cuối file (sau REFERENCES) |
...
The system is organised as a two-stage pipeline<!--【SỬA-05】 SUMMARY: "three-stage"→"two-stage" (bỏ tầng ArcFace không có thật)-->. The first stage is deepfake detection. The baseline is an EfficientNet-B4 spatial classifier. On top of it the thesis proposes SFDCT, which adds a block-wise discrete cosine transform branch and injects the frequency information through a zero-initialised gated cross-attention, so the frequency path is added on top of the backbone rather than replacing it. An improved variant, SFDCT-HFF, keeps the high-frequency residual of the transform as a high-pass image before fusion. The second stage is liveness detection, a presentation-attack check that runs first in the cascade as a cheap pre-filter against printed photos and screen replays. It reuses the same EfficientNet-B4 backbone, comparing a spatial baseline (B4-liveness) against a spatial-plus-frequency variant (B4+DCT-liveness).<!--【SỬA-06】 SUMMARY liveness: sai phương pháp (MediaPipe/EAR/head-pose/ArcFace) → đổi đúng B4-liveness vs B4+DCT-liveness; bỏ ArcFace-->
...
Major: Data Science and Artificial Intelligence<!--【SỬA-07】 chính tả: "Artificial Intelligent"→"Intelligence"-->
...
# ASSURANCE 【SỬA-08】<!--【SỬA-08】 chính tả tiêu đề: "ASSURRANCE"→"ASSURANCE"-->
...
All references, documents, and materials used in this thesis have been clearly cited with the authors' names, publication titles, and sources. I have tried my best<!--【SỬA-09】 đại từ: "our best"→"my best" (1 tác giả)--> to ensure that all information is presented accurately and honestly.
...
[**ASSURANCE 2**](#assurance)<!--【SỬA-10】 mục lục: "ASSURRANCE"→"ASSURANCE"-->
...
[1.11. The eKYC Context and the Operating Point 28](#the-ekyc-context-and-the-operating-point)<!--【SỬA-15】 mục lục: cập nhật tên mục 1.11-->
...
【SƠ-ĐỒ-10】
<!--【SƠ-ĐỒ-10】 VẼ MỚI (Claude soạn từ thân bài): REST request/response (mô tả ở mục 1.4) — kiểm tra đúng kiến trúc rồi dùng-->
```mermaid
sequenceDiagram
...
Figure 1.1: REST API Architecture<!--【SỬA-11】 viết hoa acronym: "Rest API"→"REST API"-->
...
<!--【ẢNH-01】 chèn ../figures/fig_1_2_mbconv.png cho Figure 1.2: The MBConv block. -->
...
【ẢNH-02】
![Figure 1.3: Zigzag scan and the 16 frequency bands](../figures/fig_1_3_zigzag.png)
<!--【ẢNH-02】 chèn ../figures/fig_1_3_zigzag.png cho Figure 1.3: Zigzag scan and the 16 frequency bands. -->
...
【ẢNH-03】
![Figure 1.4: Gated cross-attention fusion](../figures/fig_1_4_gate_fusion.png)
<!--【ẢNH-03】 chèn ../figures/fig_1_4_gate_fusion.png cho Figure 1.4: Gated cross-attention fusion. -->
...
5.  ## The eKYC Context and the Operating Point<!--【SỬA-14】 mục 1.11 trùng tên với 1.10 → đổi thành "The eKYC Context and the Operating Point"-->
    
    1.  ###  The role of eKYC against deepfakes 【DRAFT-01】
...
<!--【DRAFT-01】 draft 1.11.1 vai trò eKYC chống deepfake — Claude DRAFT, đọc lại rồi thêm vào Docs-->
    
    2.  ###  Circular 17/2024/TT-NHNN and the chosen operating point 【DRAFT-02】
...
<!--【DRAFT-02】 draft 1.11.2 Circular 17 + điểm vận hành FPR<=5% — Claude DRAFT, đọc lại rồi thêm vào Docs-->
    
    3.  ###  The need for explainability 【DRAFT-03】
...
<!--【DRAFT-03】 draft 1.11.3 nhu cầu explainability (Grad-CAM) — Claude DRAFT, đọc lại rồi thêm vào Docs-->

6.  ## Liveness Detection Theory
    
    1.  ###  The role of liveness in eKYC 【DRAFT-04】
...
<!--【DRAFT-04】 draft 1.12.1 vai trò liveness trong eKYC — Claude DRAFT, đọc lại rồi thêm vào Docs-->
    
    2.  ###  Types of presentation attack 【DRAFT-05】
...
<!--【DRAFT-05】 draft 1.12.2 loại tấn công trình diễn (print/replay/mask) — Claude DRAFT, đọc lại rồi thêm vào Docs-->
    
    3.  ###  Passive and active liveness 【DRAFT-06】
...
<!--【DRAFT-06】 draft 1.12.3 passive vs active liveness — Claude DRAFT, đọc lại rồi thêm vào Docs-->
...
【SƠ-ĐỒ-01】
<!--【SƠ-ĐỒ-01】 Figure 2.1 use-case — đã bọc lại mermaid, kiểm tra render-->
```mermaid
flowchart LR
Anon([Anonymous])
Viewer([Viewer])
...
【ẢNH-04】
![Figure 2.2: System architecture](../figures/fig_2_2_architecture.png)
<!--【ẢNH-04】 chèn ../figures/fig_2_2_architecture.png cho Figure 2.2: System architecture. -->

*Figure 2.2: System architecture.*

The system is organised into five blocks<!--【SỬA-12】 sai số: "4 blocks" nhưng liệt kê 5 (FE/BE/Model/Monitoring/Alerting)→"five"-->, each with one responsibility, so that a block can be replaced without breaking the rest.
...
【SƠ-ĐỒ-02】
<!--【SƠ-ĐỒ-02】 Figure 2.3 activity deepfake — đã bọc lại mermaid, kiểm tra render-->
```mermaid
flowchart TD
...
【SƠ-ĐỒ-03】
<!--【SƠ-ĐỒ-03】 Figure 2.4 activity eKYC — đã bọc lại mermaid, kiểm tra render-->
```mermaid
flowchart TD
...
【SƠ-ĐỒ-04】
<!--【SƠ-ĐỒ-04】 Figure 2.5 sequence deepfake — đã bọc lại mermaid, kiểm tra render-->
```mermaid
sequenceDiagram
actor U as User
...
【SƠ-ĐỒ-05】
<!--【SƠ-ĐỒ-05】 Figure 2.6 sequence eKYC — đã bọc lại mermaid, kiểm tra render-->
```mermaid
sequenceDiagram
...
【SƠ-ĐỒ-07】
<!--【SƠ-ĐỒ-07】 VẼ MỚI (Claude soạn từ thân bài): kiến trúc SFDCT (B4 + nhánh block-DCT + gated cross-attention) — kiểm tra đúng kiến trúc rồi dùng-->
```mermaid
flowchart LR
...
*Figure 2.7: Overall architecture of SFDCT.*<!--【SỬA-01】 trùng số: Figure 2.2(model)→2.7 (2.2 đã là System architecture)-->
...
【SƠ-ĐỒ-08】
<!--【SƠ-ĐỒ-08】 VẼ MỚI (Claude soạn từ thân bài): kiến trúc SFDCT-HFF (high-pass residual + multi-scale + residual-guided attention) — kiểm tra đúng kiến trúc rồi dùng-->
```mermaid
flowchart LR
...
*Figure 2.8: Overall architecture of SFDCT-HFF.*<!--【SỬA-02】 trùng số: Figure 2.3(model)→2.8-->
...
【SƠ-ĐỒ-09】
<!--【SƠ-ĐỒ-09】 VẼ MỚI (Claude soạn từ thân bài): kiến trúc B4-liveness baseline (B4 spatial-only + head nhị phân) — kiểm tra đúng kiến trúc rồi dùng-->
```mermaid
flowchart LR
...
*Figure 2.9: Architecture of the B4-liveness baseline.*<!--【SỬA-03】 trùng số: Figure 2.4(model)→2.9-->
...
【SƠ-ĐỒ-11】
<!--【SƠ-ĐỒ-11】 VẼ MỚI (Claude soạn từ thân bài): kiến trúc B4+DCT-liveness (B4 + block-DCT + gated fusion) — kiểm tra đúng kiến trúc rồi dùng-->
```mermaid
flowchart LR
...
*Figure 2.10: Architecture of the B4+DCT-liveness proposal.*<!--【SỬA-04】 trùng số: Figure 2.5(model)→2.10-->
...
【ẢNH-05】
![Figure 3.1: Real/fake distribution](../figures/fig_3_1_distribution.png)
<!--【ẢNH-05】 chèn ../figures/fig_3_1_distribution.png cho Figure 3.1: Real/fake distribution. -->
...
【ẢNH-06】
![Figure 3.2: Real/fake pair + spectrum](../figures/fig_3_2_preprocess_realfake.png)
<!--【ẢNH-06】 chèn ../figures/fig_3_2_preprocess_realfake.png cho Figure 3.2: Real/fake pair + spectrum. -->
...
【ẢNH-07】
![Figure 3.3: Mean frequency energy by band](../figures/fig_3_11_frequency.png)
<!--【ẢNH-07】 chèn ../figures/fig_3_11_frequency.png cho Figure 3.3: Mean frequency energy by band. -->
...
【ẢNH-16】
![Figure 3.4: Model summary of EfficientNet-B4 baseline](../figures/fig_3_4_summary_b4.png)
<!--【ẢNH-16】 chèn ../figures/fig_3_4_summary_b4.png cho Figure 3.4: Model summary of EfficientNet-B4 baseline. 17.55M params — đếm param thật từ model load qua DETECTOR-->

*Figure 3.4: Model summary of the baseline.*

【ẢNH-08】
![Figure 3.5: Training curve of baseline (B4)](../figures/fig_3_3_train_b4.png)
<!--【ẢNH-08】 chèn ../figures/fig_3_3_train_b4.png cho Figure 3.5: Training curve of baseline (B4). -->
...
【ẢNH-17】
![Figure 3.6: Model summary of SFDCT](../figures/fig_3_6_summary_sfdct.png)
<!--【ẢNH-17】 chèn ../figures/fig_3_6_summary_sfdct.png cho Figure 3.6: Model summary of SFDCT. 18.08M params; nhánh block-DCT 0 param (biến đổi cố định), chỉ fusion thêm 0.53M-->

*Figure 3.6: Model summary of SFDCT.*

【ẢNH-09】
![Figure 3.7: Training curve of SFDCT (naive)](../figures/fig_3_4_train_naive.png)
<!--【ẢNH-09】 chèn ../figures/fig_3_4_train_naive.png cho Figure 3.7: Training curve of SFDCT (naive). -->
...
【ẢNH-18】
![Figure 3.8: Model summary of SFDCT-HFF (full)](../figures/fig_3_8_summary_hff.png)
<!--【ẢNH-18】 chèn ../figures/fig_3_8_summary_hff.png cho Figure 3.8: Model summary of SFDCT-HFF (full). 22.77M params; HFStream +5.21M-->

*Figure 3.8: Model summary of SFDCT-HFF, full version.*

【ẢNH-19】
![Figure 3.9: Training curve of SFDCT-HFF (HFF-R3)](../figures/fig_3_9_train_hff_r3.png)
<!--【ẢNH-19】 chèn ../figures/fig_3_9_train_hff_r3.png cho Figure 3.9: Training curve of SFDCT-HFF (HFF-R3). Claude generate từ console-capture 11 điểm thật (hff_r3); peak 0.7551/epoch, best-ckpt 0.7695 ở Bảng 3.5-->
...
【ẢNH-3.4v2】
![Training dynamics — in-distribution vs cross-dataset](../figures/fig_3_4_v2_train_dynamics.png)
<!--【ẢNH-3.4v2】 TẠM (thêm, chưa thay 3.5/3.7/3.9): chèn ../figures/fig_3_4_v2_train_dynamics.png — train loss + FF++ test (in-distribution) + Celeb-DF test (cross-dataset) cho B4 & SFDCT, số THẬT từ log. HFF-R3 mất log per-epoch nên không có; best ở Bảng. Định vị bằng cụm .... -->

*Supplementary figure (....): Training dynamics — in-distribution (FaceForensics++) versus cross-dataset (Celeb-DF-v2). The in-distribution test AUC stays high and stable (about 0.95–0.97), while only the cross-dataset AUC oscillates; the wobble is a generalisation gap, not failed optimisation.*
...
【ẢNH-10】
![Figure 3.10: ROC curves](../figures/fig_3_7_roc.png)
<!--【ẢNH-10】 chèn ../figures/fig_3_7_roc.png cho Figure 3.10: ROC curves. -->

*Figure 3.10: ROC curves on the test set; the marked line is the 5 percent false-positive constraint.*

【ẢNH-11】
![Figure 3.11: Precision-recall](../figures/fig_3_8_pr_curve.png)
<!--【ẢNH-11】 chèn ../figures/fig_3_8_pr_curve.png cho Figure 3.11: Precision-recall. -->
...
【ẢNH-12】
![Figure 3.12: Confusion matrix](../figures/fig_3_9_confusion.png)
<!--【ẢNH-12】 chèn ../figures/fig_3_9_confusion.png cho Figure 3.12: Confusion matrix. -->
...
【ẢNH-13】
![Figure 3.13: t-SNE 2D projection](../figures/fig_3_10_tsne.png)
<!--【ẢNH-13】 chèn ../figures/fig_3_10_tsne.png cho Figure 3.13: t-SNE 2D projection. -->
...
【ẢNH-14】
![Figure 3.14: Grad-CAM heat map](../figures/fig_3_12_gradcam.png)
<!--【ẢNH-14】 chèn ../figures/fig_3_12_gradcam.png cho Figure 3.14: Grad-CAM heat map. -->

*Figure 3.14: Heat map of the detector on a test sample; the hot regions are where the decision is made.*

【ẢNH-20】
![Figure 3.15: Example SFDCT predictions on Celeb-DF-v2 test faces](../figures/fig_3_15_predictions.png)
<!--【ẢNH-20】 chèn ../figures/fig_3_15_predictions.png cho Figure 3.15: Example SFDCT predictions on Celeb-DF-v2 test faces. 8 ví dụ thật: 2 caught + 2 accepted + 2 flagged (FP) + 2 missed (FN), verdict@τ=0.5-->
...
【ẢNH-15】
![Figure 3.16: Gate value distribution](../figures/fig_3_13_gate_alpha.png)
<!--【ẢNH-15】 chèn ../figures/fig_3_13_gate_alpha.png cho Figure 3.16: Gate value distribution. -->
...
【ẢNH-21】
![Figure 3.17: LCC-FASD live vs spoof — examples and 16-band DCT footprint](../figures/fig_3_17_liveness.png)
<!--【ẢNH-21】 chèn ../figures/fig_3_17_liveness.png cho Figure 3.17: LCC-FASD live vs spoof — examples and 16-band DCT footprint. live/spoof thật + 16-band; spoof khác về không gian nhưng ≈ live ở band-DCT → giải thích §3.1.9 (freq branch không giúp)-->
...
> 【CẦN-BẠN-01】 **[HÌNH CHỜ BỔ SUNG]** — Figure 3.18 model summary B4-liveness — bảng text
<!--【CẦN-BẠN-01】 Figure 3.18 model summary B4-liveness — bảng text-->
...
> 【CẦN-BẠN-02】 **[HÌNH CHỜ BỔ SUNG]** — Figure 3.19 — ĐỀ XUẤT BỎ: metrics_liveness.json chỉ có số cuối, không có log per-epoch để dựng curve; Bảng 3.10 đã đủ
<!--【CẦN-BẠN-02】 Figure 3.19 — ĐỀ XUẤT BỎ: metrics_liveness.json chỉ có số cuối, không có log per-epoch để dựng curve; Bảng 3.10 đã đủ-->
...
【ẢNH-22】
![Figure 3.20: ROC + score distribution of B4-liveness](../figures/fig_3_20_roc_b4_liveness.png)
<!--【ẢNH-22】 chèn ../figures/fig_3_20_roc_b4_liveness.png cho Figure 3.20: ROC + score distribution of B4-liveness. chạy model trên 7580 ảnh eval thật, AUC 0.9829 khớp metrics, EER≈7%-->
...
> 【CẦN-BẠN-03】 **[HÌNH CHỜ BỔ SUNG]** — Figure 3.21 model summary B4+DCT-liveness — bảng text
<!--【CẦN-BẠN-03】 Figure 3.21 model summary B4+DCT-liveness — bảng text-->
...
> 【CẦN-BẠN-04】 **[HÌNH CHỜ BỔ SUNG]** — Figure 3.22 — ĐỀ XUẤT BỎ: không có log per-epoch; Bảng 3.10 đã đủ
<!--【CẦN-BẠN-04】 Figure 3.22 — ĐỀ XUẤT BỎ: không có log per-epoch; Bảng 3.10 đã đủ-->
...
【ẢNH-23】
![Figure 3.23: ROC + score distribution of B4+DCT-liveness](../figures/fig_3_23_roc_b4dct_liveness.png)
<!--【ẢNH-23】 chèn ../figures/fig_3_23_roc_b4dct_liveness.png cho Figure 3.23: ROC + score distribution of B4+DCT-liveness. chạy model trên 7580 ảnh eval, AUC 0.9777 khớp metrics (≈ B4, freq không giúp)-->
...
【SƠ-ĐỒ-06】
<!--【SƠ-ĐỒ-06】 Figure 3.24 deployment — đã bọc lại mermaid, kiểm tra render-->
```mermaid
flowchart TB
...
> 【CẦN-BẠN-05】 **[HÌNH CHỜ BỔ SUNG]** — Figure 3.25 home screen — ảnh chụp app; ứng viên frontend/dashboard-sample.png
<!--【CẦN-BẠN-05】 Figure 3.25 home screen — ảnh chụp app; ứng viên frontend/dashboard-sample.png-->
...
> 【CẦN-BẠN-06】 **[HÌNH CHỜ BỔ SUNG]** — Figure 3.26 deepfake screen — ảnh chụp app
<!--【CẦN-BẠN-06】 Figure 3.26 deepfake screen — ảnh chụp app-->
...
> 【CẦN-BẠN-07】 **[HÌNH CHỜ BỔ SUNG]** — Figure 3.27 liveness screen — ảnh chụp app
<!--【CẦN-BẠN-07】 Figure 3.27 liveness screen — ảnh chụp app-->
...
**Limitations**
  ...
  - > Every number comes from a single run<!--【SỬA-13】 chính tả: "EEvery"→"Every"--> per configuration, so no significance is claimed; the video-level intervals all contain zero, confirming that no variant separates from the baseline at this seed.
...
<!--【SỬA-16】 ĐÃ XÓA khối template tiếng Việt sót lại từ đây tới hết file (Ghi chú trình bày, CONCLUSION/REFERENCES/APPENDIX rỗng, 'Contentkết luận'…). Trong Google Docs bạn cũng nên xóa khối scaffold này.-->
